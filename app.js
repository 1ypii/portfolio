(function () {
  ...
  function spinTilt(a) {
    a.addEventListener("mouseenter", function () {
      a.style.setProperty("--tilt", (360 + (Math.random() * 24 - 12)).toFixed(1) + "deg");
    });
  }
  ...
  function buildWorkSection(group) {
    ...
    if (projects.length) {
      ...
      var list = el("div", (allGroups || allGames) ? "rows duo" : "rows");
  ...
  function buildSnippets() {
    ...
    snips.forEach(function (s, i) {
      ...
      tab.addEventListener("click", function () {
        ...
        panels.forEach(function (p) { p.hidden = true; p.classList.remove("is-in"); });
